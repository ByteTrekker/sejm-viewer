...
$options = Options::fromGetopt(['from::', 'to::', 'db::', 'out::', 'exclude-technical', 'name::', 'lang::', 'templates::']);
...
$composer = new PageComposer(rtrim($options->string('templates', __DIR__ . '/../public'), '/'));
